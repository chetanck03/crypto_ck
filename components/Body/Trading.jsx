...
const Trading = ({
  ...
  const tradeFrequency = 3600 * 1000; // Every ONE HOUR
                ...
                {userMembership !== "notMember" ? (
                  <>
                    {active ? (
                      ...
                      <a
                        onClick={() => (
                          trading(activeNetwork, tradeToken), setActive(true), notifySuccess("Transaction Started...")
                        )}
