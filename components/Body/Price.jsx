                    ...
                    <div className="pricing__item">
                      <div className="pricing__item_holder">
                        <div className="pricing__item__header">
                          ...
                          <p className="desc">billed yearly
                          <br />
                    ...
                    <div className="pricing__item">
                      <div className="pricing__item_holder">
                        <div className="pricing__item__header">
                          ...
                          <p className="purchase">
                            <a  className="techwave_fn_button"
                                onClick={() => buyMemberShip("Enterprice", 0.0001)}
                            >
                              Buy Enterprice
                            </a>
                          </p>
                      ...
                      <div className="item_row">
                        ...
                        {/* //1 */}
                          <div className="item_col">
                            ...
                            <br />
                              <span>25</span> <span> </span>Trading monthly
                            </p>
                            <p className="purchase">
                              <a onClick={() => buyMemberShip("Personal", 0.0001)}
                          ...
                          <div className="item_col">
                            ...
                            <p className="purchase">
                              <a onClick={() => buyMemberShip("Premium", 0.0001)}
                                className="techwave_fn_button"       
                              >Buy Premium</a>
                            </p>
                          </div>
                          ...
                          <div className="item_col">
                            ...
                            <p className="purchase">
                              <a onClick={() => buyMemberShip("Enterprice", 0.0001)}
                                className="techwave_fn_button"       
                              >Buy Enterprice</a>
                            </p>
                          </div>
